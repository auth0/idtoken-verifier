...
stream.once('open', function(fd) {
  ...
  stream.write('\n');
  stream.write('\n');
  stream.write(`## [v${library.version}](https://github.com/auth0/idtoken-verifier/tree/v${library.version}) (${moment().format('YYYY-MM-DD')})`);
  stream.write('\n');
  stream.write(`[Full Changelog](https://github.com/auth0/idtoken-verifier/compare/v${currentVersion}...v${library.version})`);
  stream.write('\n');
